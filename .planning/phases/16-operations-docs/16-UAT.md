...
expected: |
  Running `mix docs` completes without errors and produces HTML output in the doc/ directory. The command should exit cleanly with no warnings about missing files.
